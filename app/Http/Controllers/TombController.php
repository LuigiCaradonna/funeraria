...
class TombController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'full_width' => 'numeric|nullable',
            'full_height' => 'numeric|nullable',
            ...
            'sculpture_id' => 'nullable|exists:sculptures,id',
            'vase_id' => 'nullable|exists:vases,id',
            'lamp_id' => 'nullable|exists:lamps,id',
            'flame_id' => 'nullable|exists:flames,id',
            'picture_id' => 'nullable|exists:pictures,id',
            'outline_id' => 'nullable|exists:outlines,id',
            'cross_id' => 'nullable|exists:crosses,id',
            'decoration_id' => 'nullable|exists:decorations,id',
            'ordered_at' => 'requires|date_format:Y-m-d',
            'proofed_at' => 'requires|date_format:Y-m-d',
            'confirmed_at' => 'requires|date_format:Y-m-d',
            'done_at' => 'requires|date_format:Y-m-d',
            'delivered_at' => 'requires|date_format:Y-m-d',
        ]);
