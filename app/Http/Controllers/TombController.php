...
class TombController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            'progressive'   => 'required|numeric',
            'name'          => 'required|string',
            'additional_names'   => 'nullable|string',
            'price'         => 'nullable|numeric',
            'full_width'    => 'nullable|numeric',
            'full_height'   => 'nullable|numeric',
            ...
            'proofed_at'    => 'required|date_format:Y-m-d',
            'confirmed_at'  => 'required|date_format:Y-m-d',
            'done_at'       => 'required|date_format:Y-m-d',
