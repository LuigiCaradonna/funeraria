...
bool Sacred::store(const QString& code, const QString& name)
{
...
bool Sacred::update(const QString& old_code, const QString& code, const QString& name)
{
    QString date = QDate::currentDate().toString("yyyy-MM-dd");
...
QList<QMap<QString, QString>> Sacred::get()
{
