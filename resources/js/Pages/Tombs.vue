...
watch(search, throttle(function(value) {
    Inertia.get('/tombs', {search: value, field: field_to_order, order: list_order}, {
        preserveState: true,
        replace: true 
    });
}, 300));
...
let submitD = () => {
    swal.fire({
        ...
        text: 'Stai per eliminare ' + formD.ids.length + ' lapidi',
        icon: 'warning',
...
function listOrder(field) {
    ...
    Inertia.get('/tombs', {search: search.value, field: field_to_order, order: list_order}, {
        preserveState: true,
        replace: true 
    });
}
...
<template>
    ...
    <div class="d-flex justify-content-between">
        <div>
            <button @click="newTomb" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tombModal">
            Nuova lapide
            </button>
                    ...
                    <tr v-for="tomb in tombs.data" :key="tomb.id">
                        ...
                        <td>
                            <div class="d-flex justify-content-between">
                                ...
                                <span role="button" @click="deleteTomb(tomb)">
    ...
    <Pagination :links="tombs.links" v-if="tombs.links.length > 3"/>

    <div class="modal fade" id="tombModal" tabindex="-1" aria-labelledby="tombModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="tombModalLabel">Nuova lapide</h1>
                ...
                <div class="modal-body">
                    <form @submit.prevent="submitCU">
                        ...
                        <div class="mb-3">
                            ...
                            <select v-model="formCU.tomb_type_id" id="type" class="form-control">
                                <option v-for="tombtype in tombtypes" 
                                    :key="tombtype.id"
                                    v-text="tombtype.name"
                                    :value="tombtype.id"></option>
                            </select>
